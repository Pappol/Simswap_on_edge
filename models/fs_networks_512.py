...
class Generator_Adain_Upsample(nn.Module):
    def __init__(self, input_nc, output_nc, latent_size, n_blocks=6, deep=False,
        ...
        self.first_layer = nn.Sequential(nn.ReflectionPad2d(3), DepthwiseSeparableConv(input_nc, 32, kernel_size=7, padding=0),
                                         norm_layer(32), activation)
        ### downsample
        self.down0 = nn.Sequential(DepthwiseSeparableConv(32, 64, kernel_size=3, stride=2, padding=1),
        ...
        self.last_layer = nn.Sequential(nn.ReflectionPad2d(3), DepthwiseSeparableConv(32, output_nc, kernel_size=7, padding=0),
                                        nn.Tanh())
